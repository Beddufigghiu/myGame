(function (window) {
    ...
    ContentManager.prototype.initialize = function () {
        ...
        manifest = [
            {src: "http://localhost/myGame/assets/dino_complete4.png", id: "dino"},
                        {src: "http://localhost/myGame/assets/IMG_20140811_193721.jpg", id: "dummy"},
                        {src: "http://localhost/myGame/assets/IMG_20140811_193721.jpg", id: "dummy2"},
                        {src: "http://localhost/myGame/assets/IMG_20140811_193721.jpg", id: "dummy3"},
                        {src: "http://localhost/myGame/assets/IMG_20140811_193721.jpg", id: "dummy4"},
               {src: "http://localhost/myGame/assets/IMG_20140811_193721.jpg", id: "dummy6"},
               {src: "http://localhost/myGame/assets/IMG_20140811_193721.jpg", id: "dummy7"},
               {src: "http://localhost/myGame/assets/IMG_20140811_193721.jpg", id: "dummy8"},
               {src: "http://localhost/myGame/assets/IMG_20140811_193721.jpg", id: "dummy9"},
            {src: "http://localhost/myGame/assets/cloud1.png", id: "cloud1"},
            {src: "http://localhost/myGame/assets/cloud2.png", id: "cloud2"},
            {src: "http://localhost/myGame/assets/cloud3.png", id: "cloud3"},
            {src: "http://localhost/myGame/assets/cloud4.png", id: "cloud4"},
            {src: "http://localhost/myGame/assets/newMountain.png", id: "mountain"},
            {src: "http://localhost/myGame/assets/newMountain2.png", id: "mountain2"},
            {src: "http://localhost/myGame/assets/sun.png", id: "sun"},
            {src: "http://localhost/myGame/assets/hill.png", id: "hill"},
            {src: "http://localhost/myGame/assets/hill2.png", id: "hill2"},
            {src: "http://localhost/myGame/json/level1.json", id: "mapJSON"},
        
            //glyphs
            {src: "http://localhost/myGame/assets/glyphs/ic_play_arrow_black_48dp.png", id: "play"},
            {src: "http://localhost/myGame/assets/glyphs/ic_settings_black_48dp.png", id: "settings"},
            {src: "http://localhost/myGame/assets/glyphs/ic_pause_circle_outline_grey600_18dp.png", id: "pause"},
            {src: "http://localhost/myGame/assets/glyphs/ic_replay_black_48dp.png", id: "restart"},
            {src: "http://localhost/myGame/assets/glyphs/ic_home_black_48dp.png", id: "home"},
            {src: "http://localhost/myGame/assets/glyphs/ic_arrow_back_black_48dp.png", id: "back"},
            //sounds
            {src: "http://localhost/myGame/assets/sound/SFX_Jump_33.wav", id: "soundJump"},
            {src: "http://localhost/myGame/assets/sound/Click 001.wav", id: "soundClick"},
            {src: "http://localhost/myGame/assets/sound/Kick 005.wav", id: "soundCrash"},
            {src: "http://localhost/myGame/assets/sound/Zoom Down 001.wav", id: "soundLevelComplete"}
            ];
        
        var levels = [];
        for (var i = 1; i <= TOTAL_LEVELS; i++) {
            
            levels [i - 1] = [{src:"http://localhost/myGame/json/level" + i + ".json", id: "mapJSON" + i}];
